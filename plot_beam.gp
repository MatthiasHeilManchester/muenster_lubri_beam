...
# --- this one -- do for [i=0:7700] { plot "RESLT/beam".i.".dat" u 1:2 w lines lw 2 lc "black" title "beam step".i."" , "RESLT/beam".i.".dat" u 1:3 w lines lw 2 lc "blue" title "film step".i.""; ; pause 0.005 }
